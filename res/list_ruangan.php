...
<body>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown mx-2 d-none d-md-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="../res/list_pesanan.php">Pemesanan Anda</a></li>
    ...
    <div class="list_pemesanan d-flex justify-content-center align-items-center flex-wrap">
        ...
        <div class="card m-2" style="width: 18rem;">
            <img src="../src/img/<?= str_replace(" ", "", $row['nama_ruangan']) ?>.webp" class="card-img-top" alt="Gambar <?= $row['nama_ruangan'] ?>" width="268px" height="160px">
            <div class="card-body">
                ...
                <a href="../detail/detail_ruangan.php?ruangan=<?= $row['nama_ruangan']?>" class="btn btn-primary">Lihat
                    Detail</a>
            </div>
        </div>
        <?php endwhile; ?>
