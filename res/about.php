...
<body>
    ...
    <div class="container my-5">
        <div class="d-flex flex-wrap justify-content-lg-between justify-content-center border-bottom border-3 py-3">
    ...
    <div class="container mt-5">
        <div
            class="d-flex flex-wrap align-items-center align-items-lg-between flex-column-reverse flex-lg-row border-bottom border-3">
